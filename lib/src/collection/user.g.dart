...
User _userDeserialize(
  ...
  object.status = _UserstatusValueEnumMap[reader.readByteOrNull(offsets[1])] ??
      Status.draft;
...
extension UserQueryWhereSort on QueryBuilder<User, User, QWhere> {
  ...
  QueryBuilder<User, User, QAfterWhere> anyTitle() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQueryWhere on QueryBuilder<User, User, QWhereClause> {
  ...
  QueryBuilder<User, User, QAfterWhereClause> titleIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterWhereClause> titleIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterWhereClause> titleEqualTo(String? title) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'title',
        value: [title],
  ...
  QueryBuilder<User, User, QAfterWhereClause> titleNotEqualTo(String? title) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<User, User, QAfterWhereClause> titleGreaterThan(
    String? title, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterWhereClause> titleLessThan(
    String? title, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterWhereClause> titleBetween(
    String? lowerTitle,
    String? upperTitle, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<User, User, QAfterWhereClause> titleStartsWith(
      String TitlePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'title',
  ...
  QueryBuilder<User, User, QAfterWhereClause> titleIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'title',
        value: [''],
  ...
  QueryBuilder<User, User, QAfterWhereClause> titleIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> recipientsIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> recipientsIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> recipientsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> recipientsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'recipients',
        0,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> recipientsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'recipients',
        0,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> recipientsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> recipientsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> recipientsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> statusEqualTo(Status value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'status',
        value: value,
...
extension UserQueryObject on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> recipientsElement(
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, List<Recipient>?, QQueryOperations> recipientsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'recipients');
    });
  }

  QueryBuilder<User, Status, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
